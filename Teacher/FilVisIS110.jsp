...
<tr><th>Navn på innlevering</th><th>Filnavn </th><th>Dato lagt til</th>
            ...
            <td><a href="FilSlettIS110.jsp?Oppgave_ID=<%=rs.getString("Oppgave_ID") %>"><button type="button" class="delete">Delete</button></a></td>
            </tr>
            <%
                }
            %>        
</table><br>
<a href="FilopplastingIS110.jsp">Legg til fil</a>
</center>
</body>
</html>
